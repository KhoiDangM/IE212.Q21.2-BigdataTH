...
top5_words_by_frequency = FOREACH (GROUP word_freq ALL) {
...
STORE top5_words_by_frequency INTO 'output_bai2_top_frequency' USING PigStorage(';');
STORE category_count_ordered INTO 'output_bai2_category' USING PigStorage(';');
STORE aspect_count_ordered INTO 'output_bai2_aspect' USING PigStorage(';');
